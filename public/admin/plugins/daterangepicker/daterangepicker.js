...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['public/admin/plugins/daterangepicker/moment', 'jquery', 'exports'], function(momentjs, $, exports) {
      root.daterangepicker = factory(root, exports, momentjs, $);
    });

  } else if (typeof exports !== 'undefined') {
    var momentjs = require('public/admin/plugins/daterangepicker/moment');
    var jQuery;
    try {
